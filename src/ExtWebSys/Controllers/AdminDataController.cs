...
namespace ExtWebSys.Controllers
{
	public class AdminDataController : Controller
	{
		...
		private int layer = 0;
		private long x = 0, level;

		private Dictionary<long, Dictionary<long, NModel.Admin_Menu>> dictListCmodel = new Dictionary<long, Dictionary<long, NModel.Admin_Menu>>();

		private Dictionary<long, NModel.Admin_Menu> dictCmodel = new Dictionary<long, NModel.Admin_Menu>();
