...
namespace DAL
{
  public  class NSQLite<N>:SQLite,INSQLAbl<N>
    {
        public NSQLite(string ConfigString,string TableName):base(ConfigString,TableName)
        ...
        public NSQLite()
            : base(SQLite.SQLiteConfigString, typeof(N).Name)
        {


        }
        public NSQLite(string ConfigString)
