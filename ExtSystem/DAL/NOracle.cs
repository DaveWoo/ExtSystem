...
namespace DAL
{
public    class NOracle<N>:Oracle,INSQLAbl<N>
    {
        public NOracle(string ConfigString,string TableName):base(ConfigString,TableName)
        ...
        public NOracle()
            : base(Oracle.OracleConfigString, typeof(N).Name)
        {


        }
        public NOracle(string ConfigString)
