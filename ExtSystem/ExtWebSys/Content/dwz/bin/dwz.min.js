...
var navTab = {
    ...
    openTab: function (tabid, url, options) {
        ...
        if (iOpenIndex >= 0) {
            ...
            var tabFrag = '<li tabid="#tabid#"><a href="javascript:" title="#title#" class="#tabid#"><span>#title# <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a></span></a></li>';
    ...
    $.taskBar = {
        ...
        addDialog: function (id, title) {
            ...
            if (!task[0]) {
                var taskFrag = '<li id="#taskid#"><div class="taskbutton close"><span>#title#</span></div><a href="#" class="close" >&times;</a></li>';
